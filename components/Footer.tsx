...
export default function Footer() {
    ...
    return (
        <footer className="dark-bg flex justify-space" id='contact'>
            ...
            <ul className="flex">
                <li>
                    <a href="https://www.facebook.com/profile.php?id=100086721786780&mibextid=ZbWKwL" target="_blank" rel="noreferrer">
                        <Image src="/icons/facebook.svg" width={24} height={24} alt="facebook-icon" />
                    </a>
                </li>
                <li>
                    <a href="https://www.instagram.com/jettokidinventor?utm_source=qr" target="_blank" rel="noreferrer">
                        <Image src="/icons/instagram.svg" width={24} height={24} alt="instagram-icon" />
                    </a>
                </li>
                <li>
                    <a href="https://github.com/Tanawat599" target="_blank" rel="noreferrer">
                        <Image src="/icons/github.svg" width={24} height={24} alt="github-icon" />
                    </a>
                </li>
                <li>
                    <a href="https://www.youtube.com/@KidInventorJetto" target="_blank" rel="noreferrer">
